                    ...
                    <div class="row">
                        <div class="col-xl-10 col-lg-12">
                            <div class="plots-list__header__desc">
                                <?php if ($title_price_plot_karwia = get_field('title_price_plot_karwia')) : ?>
                                    <h2 class="f-h2"><?php echo $title_price_plot_karwia; ?></h2>
                                <?php endif; ?>
                                <?php if ($text_price_plot_karwia = get_field('text_price_plot_karwia')) : ?>
                                    <div class="text-main">
                                        <?php echo $text_price_plot_karwia; ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <div data-plot-list-plot-template>
                    <div class="plot-item" data-plot-class-param="status">
                        ...
                        <div class="plot-quality">
                            <img src="<?php bloginfo('template_url'); ?>/assets/img/invest-karwia/price/image1.svg" alt="17 lat doświadczenia">
                            <img src="<?php bloginfo('template_url'); ?>/assets/img/invest-karwia/price/image3.svg" alt="700 zadowolonych klientów">
