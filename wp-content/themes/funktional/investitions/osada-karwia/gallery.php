            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="gallery">
                        ...
                        <!-- ZDJĘCIA -->
                        <?php
                        $images = get_field('photo_ek_gallery');
                        if ($images) : ?>
                        ...
                        <!-- FILMY -->
                        <?php
                        $videos = get_field('movie_ek_gallery');
                        if ($videos) : ?>
                            ...
                            <?php endforeach; ?>
                        <?php endif; ?>
                        <?php if (have_rows('movie_youtube_ek_gallery')) : ?>
                            <?php while (have_rows('movie_youtube_ek_gallery')) : the_row();
                                $ytLinkUrl = get_sub_field('link_movie_youtube_ek_gallery');
