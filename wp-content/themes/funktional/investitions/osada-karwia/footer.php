                ...
                <div class="col-xl-2 col-lg-4 col-md-6">
                    <div class="footer-box">
                        ...
                        <div class="footer-box__info footer-box__map">
                            <a class="text-main text-main--f12 text-main--fw600 text-main--white text-main--ls4" href="<?php the_permalink(1248); ?>">CENY DZIAŁEK
                            </a>
                            <a class="text-main text-main--f12 text-main--fw600 text-main--white text-main--ls4" href="<?php the_permalink(1244); ?>">STRONA GŁÓWNA
                            </a>
                            <a class="text-main text-main--f12 text-main--fw600 text-main--white text-main--ls4" href="<?php the_permalink(1250); ?>">GALERIA
                            </a>
                            <a class="text-main text-main--f12 text-main--fw600 text-main--white text-main--ls4" href="<?php the_permalink(1247); ?>">LOKALIZACJA
                            </a>
                            <a class="text-main text-main--f12 text-main--fw600 text-main--white text-main--ls4" href="<?php the_permalink(1245); ?>">KONTAKT
                            </a>
