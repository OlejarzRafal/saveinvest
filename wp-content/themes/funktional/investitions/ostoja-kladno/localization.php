...
?>
<section class="kladno-nav">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="kladno-nav-container">
                    <div class="kladno-nav-container__logo">
                        <img src="/invest-kladno/kladno-photo/nav/nav-logo.png" alt="" />
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-7">
                <div class="hero1-location__map">
                    <img src="/invest-kladno/kladno-photo/location/location-map.png" alt="" />
                </div>
            </div>
        </div>
    </div>
...
<section class="map-location">
    <img src="/invest-kladno/kladno-photo/location/map-sea.jpg" alt="" />
</section>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="footer__logo">
                    <a href="#">
                        <img src="/invest-kladno/kladno-photo/home-page/home-footer-logo.png" alt="logo saveinvest" />
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-4 col-md-6">
                <div class="footer-box">
                    ...
                    <div class="footer-box__info footer-box__map">
                        <a class="text-main text-main--f12 text-main--fw600 text-main--white text-main--ls4" href="#">LOKALIZACJA
                        </a>
