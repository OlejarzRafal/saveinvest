        ...
        <div class="singlePost">
            <div class="container">
                <div class="blog-sec-nav">
                    <a href="<?php echo get_home_url(); ?>/aktualnosci-z-terenow/" class="blog-sec-nav__back">
                        WRÓĆ DO AKTUALNOŚCI Z TERENÓW
                    </a>
                </div>
            </div>
            <div class="container">
                ...
                <div class="slider-aktualnosci slider-blog">
                    ...
                    <div class="slider-aktualnosci-loop swiper">
                        ...
                        <div class="slider-blog__nav">
                            ...
                            <a href="#" class="btn">ZOBACZ WSZYSTKIE AKTUALNOŚCI</a>
                        </div>
                    </div>
